...
module.exports = async function () {
    ...
    let options_pattern = [
        ...
        { option_id: 10, name: 'orders_in_the_city', comment: 'ability_to_place_orders', value: '', role: 'customer', limit: 50, type: 'order_range', country: '' },
        { option_id: 11, name: 'orders_in_the_city', comment: 'ability_to_place_orders', value: '', role: 'customer', limit: 50, type: 'order_range', country: '' },
        ...
        { option_id: 13, name: 'orders_in_the_city', comment: 'number_of_tracking_cities', value: '', role: 'carrier', limit: 3, type: 'order_range', country: '' },
