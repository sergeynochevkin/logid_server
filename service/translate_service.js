class TranslateService {
    ...
    constructor() {
        this._translation = [
            ...
            // { service: '', russian: '', english: '', spain: '', color: '', type: 'server_notification' },   
            // { service: '', russian: '', english: '', spain: '', color: '', type: 'server_notification' },   
            // { service: '', russian: '', english: '', spain: '', color: '', type: 'server_notification' },   
        ]
    }
    ...
    async setTranslate(service, type, to_lower) {
        let language = 'english' // получить решить откуда
        let translatedText = this._translation.find(el => el.service === service && el.type === type)
        if (to_lower) {
            translatedText = translatedText[language].toLowerCase()
        } else {
